            ...
            <asp:GridView CssClass="grid-quanly" ID="GridView2" runat="server" AutoGenerateColumns="False" ShowFooter="True" ShowHeaderWhenEmpty="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="UserName">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("taikhoan") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="FullName">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("ten") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Quyền Hạn">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("quyen") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtquyenfooter" runat="server" />
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label6" runat="server" Text='<%# Bind("quyen") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Trạng Thái">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("khoa") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtkhoafooter" runat="server" />
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label7" runat="server" Text='<%# Bind("khoa") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
